  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-editor/85 backdrop-blur-sm p-4 overflow-y-auto">
      <motion.div
        ...
        className="w-full max-w-2xl bg-sidebar border border-border-color rounded-2xl shadow-2xl overflow-hidden flex flex-col my-8"
      ...
      >
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto p-8 flex flex-col items-center justify-center bg-[#dde3ec]/40 scrollbar-none">
          {/* Mockup A4 panel */}
