                  ...
                  >
                    <div className="text-xs">
                      <div className="flex justify-between font-bold text-slate-800">
                        ...
                        {showDates && (
                          <E field="experience.dates" value={exp.dates} isEditable={isEditable} editableClass={ec} className="text-slate-500 font-normal" onSave={v => onExperienceChange?.(idx, 'dates', v)} />
                        )}
                      </div>
                  ...
                  >
                    <div className="text-xs">
                      ...
                      <EducationDescription
                        ...
                        className={`text-slate-700 text-${educationAlign}`}
